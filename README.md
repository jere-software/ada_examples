...
Any command line options can be supplied along with the executable.

## 1.2. Running via [Alire](https://alire.ada.dev/)
In the top level directory execute the following command:<br>
`alr run`

Any command line options can be supplied along with the above Alire command using the `-a` switch (and may need to be wrapped in quotes if more than one option is supplied.  See the Alire documentation for more details).
...
## 2.3. Building with [Alire](https://alire.ada.dev/)
